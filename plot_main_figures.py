...
E, E_int = [1.25, 2.05, 1.33, 2.14], .2 # Energies for Plotting Time Traces ; 1st Energy for MM
#E, E_int = [1.33, 2.14], .2 # Energies for Plotting Time Traces ; 1st Energy for MM
...
colors = ['black', 'red', 'grey', 'pink'] #colors for plotting the traces
...
for i in np.arange(len(E)):
    ...
    if i < 2:
        trace = mpes.get_time_trace(I_res, E[i], E_int, (kx, ky), (kx_int, ky_int), norm_trace = True, subtract_neg = subtract_neg, neg_delays = neg_delays)
    elif i > 1:
        trace = mpes.get_time_trace(I_res2, E[i], E_int, (kx, ky), (kx_int, ky_int), norm_trace = True, subtract_neg = subtract_neg, neg_delays = neg_delays)
